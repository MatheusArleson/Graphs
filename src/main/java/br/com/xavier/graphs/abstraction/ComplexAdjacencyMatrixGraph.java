...
public abstract class ComplexAdjacencyMatrixGraph extends AdjacencyMatrixGraph {

	private static final boolean LOOPS_ALLOWED = true;
	private static final boolean MULTIPLE_EDGES_ALLOWED = false;
	
	public ComplexAdjacencyMatrixGraph(NodeFactory nodeFactory, EdgeFactory edgeFactory) {
