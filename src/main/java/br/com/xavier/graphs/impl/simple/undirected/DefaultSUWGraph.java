...
public class DefaultSUWGraph<N extends AbstractNode, E extends AbstractWeightedEdge<N,T>, T extends Comparable<T>>
	   extends SimpleUndirectedWeightedGraph<N, E, T> {
