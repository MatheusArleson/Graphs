...
public abstract class SimpleDirectedWeightedGraphTest<N extends AbstractNode, E extends AbstractWeightedEdge<N,T>, T extends Comparable<T>> 
				extends SimpleDirectedGraphTest<N, E> {
